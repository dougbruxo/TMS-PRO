...
import type { Quote, Company, Vehicle, User as AuthUser, FreightMode, BillingHistoryEvent, QuoteStatus, MinimumFreightValues } from '@/lib/types';
    ...
    <main className="container mx-auto p-4 md:p-8">
      <div className="flex justify-between items-center mb-2">
          <h1 className="text-3xl font-bold text-primary">
              {editingQuoteId ? 'Refazendo Cotação' : freightMode === 'armazenagem' ? 'Cotação de Armazenagem' : 'Cotação de Frete'}
          </h1>
